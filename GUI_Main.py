...
#
label_l1 = tk.Label(root, text="Fake Currency Detection System",font=("Callibri", 30, 'bold'),
                    background="orange", fg="white", width=62, height=2)
...
frame_alpr = tk.LabelFrame(root, text=" --Login & Register-- ", width=595, height=225, bd=5, font=('times', 14, ' bold '),bg="#6CC417")
...
button1 = tk.Button(frame_alpr, text="Login", command=log, width=15, height=1,font=('times', 15, ' bold '), bg="#8B0000", fg="white")
...
label_l1 = tk.Label(root, text="** Fake Curraecy Detection System @2021 By **",font=("Times New Roman", 10, 'bold'),
                    background="black", fg="Red", width=250, height=2)

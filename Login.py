...
button1 = tk.Button(root, text="HOME", command=home, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="skyblue", fg="Blue")
button1.place(x=185, y=250)

button2 = tk.Button(root, text="REGISTER",command=reg,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="skyblue", fg="Blue")
button2.place(x=185, y=350)

button4 = tk.Button(root, text="EXIT", command=window, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="skyblue", fg="Blue")
